...
int main() {
    try {
        ...
        sf::RenderWindow window(sf::VideoMode(208 * SCALE, 208 * SCALE), "Battle City [beta 1.23]", sf::Style::Close);
        ...
        while (window.isOpen()) {
            ...
            window.setTitle("Battle City [beta 1.23] - " + std::to_string((uint16_t)(1 / fpsClock.getElapsedTime().asSeconds())) + " fps");
        }
    }
